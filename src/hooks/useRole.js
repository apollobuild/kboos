const ROLE_ACCESS = {
  admin:    ['dashboard','businesses','add-business','campaigns','new-campaign','campaign-dashboard','lead-intelligence','ai-studio','ai-campaign-studio','revenue','revenue-analytics','campaign-analytics','channel-analytics','leads','replies','approvals','reporting','prompt-studio','live-demo','settings','client-portal','pipeline','business-detail','unified-inbox','email-inbox','whatsapp-inbox','wa-connect-inbox','voice-outcomes','meetings','changelog'],
